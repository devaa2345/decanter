...
- explicit_ask is true only if the customer is asking about price, availability, or buying right now. This is a real decision, not a formality — nothing else will catch a mistake here.
  ...
  * A LIST of product names IS an explicit ask, however long, and with or without brand headings or bullets. A customer who pastes "Al Haramain: - Detour Noir - Detour Eco   Armaf: - Club de Nuit Untold" is telling you what they want to buy. Return every candidate from the list above that they named, and set explicit_ask true.
